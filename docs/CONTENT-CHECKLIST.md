...
|---|---|---|---|
| 5 | **Project name** | **Required** | "Faisal Jewel" |
| 6 | **Exact location** | **Required** | "Executive Block, Faisal Hills, Taxila" |
| 7 | **Developer name** | **Required** | "Zedem Properties & CAM Constructions" — we must name who is actually building it |
| 8 | **Our role** | **Required** | "Authorised Sales Partner" |
| 9 | **Approval / NOC status** | **Required** | Exact wording. Never round "pending" up to "approved". |
| 10 | **One-line description** | **Required** | Shown on the card. About 20 words. |
| 11 | **Full description** | **Required** | 1–2 paragraphs: what it is, who it suits, why the location matters. |
| 12 | **Key features** (4–6 bullets) | **Required** | "Radisson Blu hotel suites", "Three basement parking levels" |
| 13 | **Amenities list** | Optional | Security, pool, gym, food court, backup power — as many as apply |
| 14 | **Building structure** | Optional | "27+ floors: retail on lower levels, offices mid, apartments above" |
| 15 | **Status** | **Required** | Completed / In Progress / Planned |
| 16 | **Expected completion** | Optional | "Q4 2027" |

### 1C. Commercial details
...
| # | Item | Required? | Example |
|---|---|---|---|
| 9 | **Finish type** | **Required** | Gray Structure **or** Fully Finished |
...
| # | Item | Required? | Example |
|---|---|---|---|
| 16 | **Start date** | Optional | "March 2025" — when we broke ground |
| 17 | **Completion date** | Required if completed | "January 2026" |
| 18 | **Expected completion** | Required if ongoing | "Q2 2027" |
