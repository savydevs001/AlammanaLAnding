      ...
      <div className="max-w-[1600px] mx-auto px-4">
        <header className="mb-20 text-center max-w-3xl mx-auto">
          ...
          <p className="text-ink/60 leading-relaxed font-medium">
            Practical guides on construction costs, materials, approvals and property investment
            in Faisal Hills, Faisal Town and the wider Islamabad region — written for buyers,
